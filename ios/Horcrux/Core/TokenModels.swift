...
enum TokenList {
    ...
    static let polygon: [Token] = [
        // Bridged USDT — by far the dominant stablecoin on Polygon.
        Token(id: "0xc2132D05D31c914a87C6611C10748AEb04B58e8F", chain: .polygon,
              symbol: "USDT", name: "Tether USD", decimals: 6, iconURL: nil),
        // Native USDC (Circle-issued), not the older bridged variant.
        Token(id: "0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359", chain: .polygon,
              symbol: "USDC", name: "USD Coin", decimals: 6, iconURL: nil),
    ]

    static let arbitrum: [Token] = [
        Token(id: "0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", chain: .arbitrum,
              symbol: "USDT", name: "Tether USD", decimals: 6, iconURL: nil),
        // Native USDC on Arbitrum One.
        Token(id: "0xaf88d065e77c8cC2239327C5EDb3A432268e5831", chain: .arbitrum,
              symbol: "USDC", name: "USD Coin", decimals: 6, iconURL: nil),
        Token(id: "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", chain: .arbitrum,
              symbol: "WETH", name: "Wrapped Ether", decimals: 18, iconURL: nil),
    ]

    static let base: [Token] = [
        // Native USDC on Base (Circle-issued, the one you should use).
        Token(id: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", chain: .base,
              symbol: "USDC", name: "USD Coin", decimals: 6, iconURL: nil),
        Token(id: "0x4200000000000000000000000000000000000006", chain: .base,
              symbol: "WETH", name: "Wrapped Ether", decimals: 18, iconURL: nil),
    ]
