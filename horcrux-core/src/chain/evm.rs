...
mod tests {
    ...
    //
    // (Removed in round 18.) Horcrux no longer supports EIP-712
    // typed-data signing — see docs/security-audit-2026-04.md §H8
    // for the rationale and the list of deleted symbols.
}
